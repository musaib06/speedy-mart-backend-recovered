namespace Siffrum.Ecom.ServiceModels.Foundation.Base.CommonResponseRoot
{
    public class DomainConstantsRoot
    {
        ...
        public class ClaimsRoot
        {
            ...
            public const string Claim_AdminId = "adId";

            public const string Claim_LoginUserType = "uTyp";

            public const string Claim_DbRecordId = "dbRId";

            public const string Claim_SecurityStamp = "secStamp";
        }
        ...
        public class DisplayMessagesRoot
        {
            ...
            public const string Display_Id_NotFound = "User Id Not Found In Claims";
            public const string Display_AdminId_NotFound = "Admin Id Not Found In Claims";
            public const string Display_Role_NotFound = "Unauthorized Role Found In Claims";
        }
    }
}
